...
# Dataset Config
parser.add_argument('--data_dir', type=str, default='/media/Storage2/yyz/Pretreat',
                    help='the path of data')
parser.add_argument('--label_dir', type=str, default='/media/Storage2/yyz/Pretreat',
                    help='the path of label')
parser.add_argument('--model_path', type=str, default=None,    #'/home/yyz/result/writer/model_RTrans_68.pth',
...
parser.add_argument('--enable_GPUs_id', type=list, default=[5], 
...
parser.add_argument('--optimizer', type=str, help = 'setting the type of optimizer',
                    default='AdamW')
parser.add_argument('--loss_type', type=list, default=None,
